...
def lambda_handler(event, context):
    ...
    parm = ssmClient.get_parameter(Name='/mompopcafe/dbUrl')
    dbUrl = parm['Parameter']['Value']

    parm = ssmClient.get_parameter(Name='/mompopcafe/dbName')
    dbName = parm['Parameter']['Value']

    parm = ssmClient.get_parameter(Name='/mompopcafe/dbUser')
    dbUser = parm['Parameter']['Value']

    parm = ssmClient.get_parameter(Name='/mompopcafe/dbPassword')
